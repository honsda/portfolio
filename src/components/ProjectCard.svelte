<script>
  import { ArrowUpRightIcon } from '@indaco/svelte-iconoir/arrow-up-right';
  export let num = "01";
  export let title = "";
  export let desc = "";
  export let tags = [];
...
<a 
  ...
  class="group relative block p-8 bg-ink-black border border-white/5 transition-colors duration-500 hover:bg-ink-surface fade-up"
>
  <!-- Animated Top Border -->
  <div 
...
=======
      <p class="font-mono text-[9px] text-paper-dim leading-[1.8] line-clamp-3">
>>>>>>> ea81e20a760172e026e7c30beda78006dcab80c4
        {desc}
      </p>
      </div>
    ...
    <div class="flex flex-col gap-6">
      ...
      <div class="flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.15em] text-paper-mid">
        View Project
        <div class="transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
